...
final class Utilities
{
    ...
    public static function get_default_attributes_translation( $product_id, $lang = '' ) {
        ...
        if ( $product && 'variable' === $product->product_type ) {
            ...
            $terms              = array(); // Array of terms: - if the term is taxonomy: term object, otherwise array (term slug => term value)
            $langs              = array();
     ...
     *
     * New translations of Variable Products are first created
     *
